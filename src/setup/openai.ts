...
const DEFAULT_SYSTEM_PROMPT = 'You are a helpful English editor. Correct grammar and style mistakes in the text provided by the user. Respond only with the corrected text, without any introductory phrases or explanations.';
 ...
 */
export const fixGrammar = async (apiKey: string, text: string, systemPrompt: string = DEFAULT_SYSTEM_PROMPT): Promise<string> => {
